...
import com.app.krambook.fragments.CategoriesFragment;
import com.app.krambook.fragments.ChatFragment;
import com.app.krambook.fragments.HomeFragment;
import com.app.krambook.fragments.ProfileFragment;
import com.app.krambook.fragments.SellFragment;
import com.app.krambook.fragments.SettingsFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText(mCurrentUser.getFullName());
        txtWebsite.setText(mCurrentUser.getEmail());
        ...
        Glide.with(this).load(mCurrentUser.getPhotoUrl())
                .crossFade()
                .thumbnail(0.5f)
    ...
    protected void onResume() {
        super.onResume();
        editProfileActivity.updateProfilePhotoThumb();
