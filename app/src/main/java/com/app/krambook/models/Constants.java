...
public class Constants {
    ...
    //Identifer
    public static int ID_PROFILE_DRAWER_ITEM = 0;
    ...
    //Drawer item code
    public final static int DRAWER_ID_SELL = 0;
    public final static int DRAWER_ID_CATEGORIES = 1;
    public final static int DRAWER_ID_CHAT = 2;
    public final static int DRAWER_ID_PROFILE = 3;
    public final static int DRAWER_ID_SETTINGS = 4;
